...
export default function FormMotor({ motor, setMotores }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-light-smoke dark:bg-midnight shadow-md rounded-md p-8 flex flex-col gap-4 flex-1 max-h-max sm:max-w-96 xl:w-[420px]">
